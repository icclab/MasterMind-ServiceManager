...
network = swagger_client.Network(engine_url=engine_url, ca_cert=ca_cert, cert=cert, cert_key=cert_key, name=network_name) # Network | Definition of network to be created
