...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Mastermind Service Manager API')
    ...
    if not valid_log_level:
        print("WARNING: Cannot parse log level parameter {0} - log level set to logging.INFO".format(args.log_level[0]))
